...
label alumni:
    ...
    neil "This is Delts. Everything good in here goes to shit."
    ...
    call game_and_select from _call_game_and_select_8
    ...
    call game_and_select from _call_game_and_select_9
    play music predestined
    ...
    mark "It might be jarring to see that it's daytime again."

    mark "But I'm scared of the dark."
    ...
    call game_and_select from _call_game_and_select_10
    play music predestined
    ...
    call start_plant_select from _call_start_plant_select_1
    ...
    call start_plant_select from _call_start_plant_select_2
    stop music fadeout 2.0
    scene clouds
    show area5
    call test_game_entry_label from _call_test_game_entry_label_2
